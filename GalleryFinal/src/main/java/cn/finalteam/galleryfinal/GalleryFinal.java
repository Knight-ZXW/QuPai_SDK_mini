...
import com.duanqu.qupaisdk.tools.StringUtils;
...
public class GalleryFinal {
    ...
    public static void clearOnHanlderResultCallback() {
     ...
     * @param callback
     */
    public static void openGalleryMuti(int requestCode,MediaType mediaType ,int maxSize, OnHanlderResultCallback callback) {
        FunctionConfig config = copyGlobalFuncationConfig();
        if (config != null) {
            config.maxSize = maxSize;
            openGalleryMuti(requestCode, mediaType ,config, callback);
        } else {
            if(callback != null) {
                callback.onHanlderFailure(requestCode, mCoreConfig.getContext().getString(R.string.open_gallery_fail));
            }
     ...
     * @param callback
     */
    public static void openGalleryMuti(int requestCode,  MediaType mediaType,FunctionConfig config, OnHanlderResultCallback callback) {
        if ( mCoreConfig.getImageLoader() == null ) {
            ILogger.e("Please init GalleryFinal.");
            if(callback != null){
                callback.onHanlderFailure(requestCode, mCoreConfig.getContext().getString(R.string.open_gallery_fail));
