...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private GalleryFinal.MediaType mediaType ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( GalleryFinal.getFunctionConfig() == null || GalleryFinal.getGalleryTheme() == null) {
            ...
            mediaType = (GalleryFinal.MediaType) getIntent().getSerializableExtra("MEDIA_TYPE");
            findViews();
            setListener();
    ...
    private void getPhotos() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                List<PhotoFolderInfo> allFolderList = (mediaType == GalleryFinal.MediaType.MediaPhoto) ? PhotoTools.getAllPhotoFolder(PhotoSelectActivity.this, mSelectPhotoList):
                        PhotoTools.getAllVideoFolder(PhotoSelectActivity.this, mSelectPhotoList);
