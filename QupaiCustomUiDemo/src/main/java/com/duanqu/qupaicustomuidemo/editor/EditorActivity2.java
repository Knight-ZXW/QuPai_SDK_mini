...
import com.duanqu.qupaicustomuidemo.editor.mediator.AudioMixChooserMediator;
import com.duanqu.qupaicustomuidemo.editor.mediator.VideoCoverMediator;
...
public class EditorActivity2 extends Activity implements View.OnClickListener, OnRenderChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tab_group.addView(findViewById(R.id.tab_effect_paster));
...
//                musicEffect, _RepoClient, _EditorSession, renderEditService.getRenderRotation());
        ...
        //封面
        VideoCoverMediator videoCoverMediator = new VideoCoverMediator();

        _EditorSession.setPart(0, overlayChooser);
        _EditorSession.setPart(1, audio_page);
        _EditorSession.setPart(2, captionChooser);
        _EditorSession.setPart(3, videoCoverMediator);
            ...
            switch (type) {
                case AssetInfo.TYPE_SHADER_MV:
                    ...
                    if(mvReturn == EffectService.EFFECTNOTPAY){
                        new AlertDialog.Builder(EditorActivity2.this)
