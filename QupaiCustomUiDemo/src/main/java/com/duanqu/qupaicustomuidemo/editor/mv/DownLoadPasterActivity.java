...
public class DownLoadPasterActivity extends FragmentActivity implements RegistUpdateDialog{
	...
	public static void show(Context context) {
		Intent intent = new Intent(context, DownLoadPasterActivity.class);
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                dialog.setUpdateDialogRegister(DownLoadPasterActivity.this);
    ...
    private void initView() {
        ...
        managerBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.setClass(DownLoadPasterActivity.this, EffectManageActivity.class);
                in.putExtra("kind", AssetRepository.Kind.DIY);
        ...
        title.setText(R.string.qupai_btn_text_download_overlay);

    }

    private void initData() {
        //TODO 整个MV下载的接口获取是没有经过包装的.
        HttpRequest.get(Api.getInstance().getApiUrl(Api.DIY_RESOURCE_CATEGORY) + "?packageName=" + getPackageName()
    ...
    private List<ResourceItem> generateDownloadList(OverlayGroup specie, AssetGroup group){
        ...
        if(list != null){
            ...
            values.put(DIYOverlayCategory.TYPE, AssetInfo.TYPE_DIYOVERLAY);
