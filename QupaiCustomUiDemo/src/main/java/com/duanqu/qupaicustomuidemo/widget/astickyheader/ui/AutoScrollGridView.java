...
public class AutoScrollGridView extends GridView {
    ...
    protected void layoutChildren() {
        ...
        if (!mSmoothScrollRequested) {
            ...
            // Since we have changed the scrolling position, we need to redo child overlay_time_edit_layout
            // Calling "requestLayout" in the middle of a overlay_time_edit_layout pass has no effect,
