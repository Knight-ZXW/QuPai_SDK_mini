...
package com.duanqu.qupaicustomuidemo.widget.astickyheader;
...
import com.duanqu.qupaicustomuidemo.widget.astickyheader.ui.FillerView;
import com.duanqu.qupaicustomuidemo.widget.astickyheader.ui.HeaderLayout;
import com.duanqu.qupaicustomuidemo.widget.astickyheader.ui.PinnedSectionGridView;
...
public class SimpleSectionedGridAdapter extends BaseAdapter implements PinnedSectionGridView.PinnedSectionGridAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (isSectionHeaderPosition(position)) {
			...
			TextView view;
			if (null == convertView) {
				convertView = FontUtil.applyFontByInflate(mContext, mSectionResourceId, parent, false);
			} else {
