...
import com.duanqu.qupai.media.FrameExtractor10.Callback;
...
public class VideoTrimAdapter extends BaseAdapter {
    ...
    public void setTimeLimit(int mDuration){
        mDurationLimit = mDuration;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = FontUtil.applyFontByInflate(mContext, R.layout.item_qupai_trim_video_thumbnail, parent, false);
            holder.thumblayout = (FrameLayout) convertView.findViewById(R.id.video_tailor_frame);
        ...
        perSecond = (float)mDurationLimit / 8;
    ...
    class ViewHolder implements Callback {
        ...
        public void onFrameExtracted(ShareableBitmap bitmap, long timestamp_nano) {
            if (bitmap != null) {
                ...
                Log.e("onFrameExtracted", "Bitmap = " + bitmap);
            }
